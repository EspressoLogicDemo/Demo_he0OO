...
var baseUrl="https://livedemo.espressologic.com/rest/demo/Demo_he0OO/v1/";

// The API key use to access the demo project
var currentApiKey = "Y2MaBNY0LHan60b";
...
function highlightChanges() {
	...
	for (var j = 0; j < allChanges.length; j++) {
		...
		(function(){
			...
			hideEntry.id = setTimeout(hideEntry.f, 5000);
